...
public class WolfSchedulerTest {
	...
	private void checkFiles(String expFile, String actFile) {
		...
		/**
		 * Tests Activities for invalid inputs and schedule conflicts.
		 */
		@Test
		public void testAddInvalidActivityToSchedule() {
		    WolfScheduler ws = new WolfScheduler(validTestFile);

		    // Add some initial courses
		    assertDoesNotThrow(() -> ws.addCourseToSchedule("CSC 216", "002"));
		    assertDoesNotThrow(() -> ws.addCourseToSchedule("CSC 226", "001"));

		    // Add an event to create a conflict scenario
		    assertDoesNotThrow(() -> ws.addEventToSchedule("Event 1", "MTWHF", 1200, 1300, ""));

		    // Attempt to add a course that conflicts
		    IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () ->
		        ws.addCourseToSchedule("CSC 230", "001")); // Adjust the name and section to actually conflict with the above schedule
